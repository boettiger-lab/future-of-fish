...
save(data, file = "../data/RAM_data_us.RData")
...
#Saving this
#save(est_bay,file = "../data/RAM_Nimble_estimates3.RData")
...
save(mean_r,mean_K,mean_G,min_r,min_K,max_r,max_K,sd_r,sd_K,file = "../data/RAM_files3.RData")
```
